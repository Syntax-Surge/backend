...
const createProduct = asyncHandler(async (req, res) => {
    ...
    const { productName, productDescription, pictureLocation, unitWeight, unitPrice, availableQuantity, categoryId } = req.body;
    ...
    try {
        ...
        res.status(500);
        throw new Error(error.message || "Some error occurred while creating the Product.");
    }
});
